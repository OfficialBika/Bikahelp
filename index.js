...
bot.use(async (ctx, next) => {
  ...
  const builtins = new Set([
    ...
    "admin","admins","addfaq","editfaq","delfaq","faqlist","save","editsave","delsave","savedlist","tickets","opentickets","closedtickets","ticketreply","closeticketadmin","reopenticket","ban","unban","user","finduser","groups","group","leavegroup","blacklistgroup","unblacklistgroup","stats","logs","errorlogs","filterlogs","ticketlogs","banlogs","addcmd","editcmd","delcmd","cmdlist","broadcast","broadcastusers","broadcastgroups","broadcastall",
